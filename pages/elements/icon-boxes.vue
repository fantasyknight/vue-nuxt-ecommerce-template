	...
	<main class="main">
		...
		<div class="page-content">
			<section class="mt-10 pt-8">
				<div class="container">
					<h2 class="title title-center mb-5">Icon &amp; Left align</h2>
					<swiper-carousel
						class="swiper-theme"
						:options="baseSlider8"
					>
			...
			<section class="mt-10 pt-4 mb-10 pb-4">
				<div class="container">
					<h2 class="title title-center mb-5">Top align</h2>
					<swiper-carousel
						class="swiper-theme"
						:options="baseSlider9"
					>
						...
						<div class="swiper-slide">
							<div class="icon-box text-center">
								...
								<div class="icon-box-content">
									<h4 class="icon-box-title">Possumus fugiendum</h4>
									<p>Sed egestas, ante et vulputate volutpat, ros pede sempe vitae luctus met.</p>
								</div>
							</div>
						</div>
			...
			<section class="grey-section pt-10 pb-10">
				<div class="container mt-4 mb-4">
					<h2 class="title title-center mb-5">Icon with border</h2>
					<swiper-carousel
						class="swiper-theme pb-6 mb-10"
						:options="baseSlider8"
					>
						<div class="swiper-slide">
					...
					<h2 class="title title-center mb-5">Inversed</h2>
					<swiper-carousel
						class="swiper-theme"
						:options="baseSlider8"
					>
			...
			<section class="mt-10 pt-4 mb-10 pb-4">
				<div class="container">
					<h2 class="title title-center mb-5">Solid Icon</h2>
					<swiper-carousel
						class="swiper-theme mb-10 pb-6"
						:options="baseSlider9"
					>
						<div class="swiper-slide">
							<div class="icon-box icon-solid text-center">
								<span class="icon-box-icon">
									...
									>
										<path
											opacity="0.5"
											d="M34.117,51.666c0.228,0.099,0.471,0.146,0.715,0.146c0.001,0,0.001,
								...
								<span class="icon-box-icon">
									...
									>
										<path
                                            ...
                                            0-0.013C66.5,6.696,53.264,0,35.48,0z"
										></path>
								...
								<span class="icon-box-icon">
									...
									>
										<path
											opacity="0.5"
											fill="#26b"
											d="M64.03,67.5H5.968c-2.125,0-4.107-1.979-5.171-3.821c-1.063-1.843-1.063-4.546,
										...
										<path
											fill="#26b"
											d="M31.756,54.585c0-1.954,1.357-3.365,3.203-3.365c1.954,0,3.203,1.411,3.203,3.365   
                                            c0,1.9-1.249,3.366-3.203,3.366C33.06,57.951,31.756,56.485,31.756,54.585z M33.113,
                                            46.82l-0.759-26.058h5.211L36.804,46.82H33.113   z"
										></path>
									</svg>
								</span>
								<div class="icon-box-content">
									...
									>
										<g>
											<g>
												...
												<path
													opacity="0.5"
													d="M29.058,31.5H55.5v-3.452c0-3.171-1.965-5.548-5.136-5.548H40.5v-6.441C40.5,
										...
										<path
											fill="#26b"
											d="M64.005,34.437c3.052,0,5.526,2.475,5.526,5.526v22.17c0,3.053-2.475,
                                            5.527-5.526,5.527H27.78  c-3.052,0-5.527-2.475-5.527-5.527v-22.17c0-3.051,2.475-5.526,
                                            5.527-5.526H64.005"
										></path>
										<path
											fill="#FFFFFF"
											d="M52.5,45.688c0,4.291-3.203,7.916-7.031,7.916c-3.791,
                                            0-6.969-3.625-6.969-7.916V43.5h-4v2.188  c0,6.479,4.998,11.75,10.969,11.75c6.006,
                                            0,11.031-5.271,11.031-11.75V43.5h-4V45.688z"
										></path>
									</svg>
								</span>
								<div class="icon-box-content">
					...
					<h2 class="title title-center mb-5">Solid icon &amp; Left align</h2>
					<swiper-carousel
						class="swiper-theme"
						:options="baseSlider8"
					>
						<div class="swiper-slide">
							<div class="icon-box icon-solid icon-box-side text-center align-items-center">
								<span class="icon-box-icon">
									<svg
										version="1.1"
										xmlns="http://www.w3.org/2000/svg"
									...
									>
										<path
											opacity="0.5"
											d="M34.117,51.666c0.228,0.099,0.471,0.146,0.715,0.146c0.001,0,0.001,0,0.001,0
									...
									>
										<g>
											<g>
												...
												<path
													opacity="0.5"
													d="M29.058,31.5H55.5v-3.452c0-3.171-1.965-5.548-5.136-5.548H40.5v-6.441C40.5,9.103,34.451,3,27.966,3
										...
										<path d="M64.005,34.437c3.052,0,5.526,2.475,5.526,5.526v22.17c0,3.053-2.475,5.527-5.526,5.527H27.78
			...
			<section class="grey-section pt-10 pb-10">
				<div class="container mt-4 mb-4">
					<h2 class="title title-center mb-5">Tiny Style</h2>
					<swiper-carousel
						class="swiper-theme"
						:options="baseSlider8"
					>
			...
			<element-list class="bg-white mt-10"></element-list>
		</div>
	</main>
</template>
...
import { baseSlider8, baseSlider9 } from '~/utils/data/carousel';
